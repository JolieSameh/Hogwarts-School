class WizardsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @wizard.save
        format.html { redirect_to wizard_url(@wizard), notice: "Wizard was successfully created." }
  ...
  def update
    respond_to do |format|
      if @wizard.update(wizard_params)
        format.html { redirect_to wizard_url(@wizard), notice: "Wizard was successfully updated." }
  ...
  private
    ...
    def wizard_params
      params.require(:wizard).permit(:name, :email, :password, :house, :bio, :birthday, :relatives)
    end
end
