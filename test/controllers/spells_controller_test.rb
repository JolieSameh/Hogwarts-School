...
class SpellsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create spell" do
    assert_difference("Spell.count") do
      post spells_url, params: { spell: { description: @spell.description, name: @spell.name } }
    end
  ...
  test "should update spell" do
    patch spell_url(@spell), params: { spell: { description: @spell.description, name: @spell.name } }
